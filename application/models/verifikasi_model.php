...
class Verifikasi_Model extends CI_Model {
	...
	function receive() {	
		...
		$data = array(
		  'verifikasi_status'=>$this->config->item('status_received'),
		  'verifikasi_status_date'=>date("Y-m-d H:i:s")
		);
		$this->db->where('id',$id);
	...
	function reject() {	
		...
		$data = array(
		  'verifikasi_status'=>$this->config->item('status_rejected'),
		  'verifikasi_status_date'=>date("Y-m-d H:i:s"),
		  'kriteria_reject'=>$kriteria,
		  'verifikasi_status_note'=>$alasan
		);
		$this->db->where('id',$id);
		$this->db->update($table_name_trx,$data);
	}
