...
$strp=259;
$strs=50;
$ttffile='C:/xampp/htdocs/pows_trial/application/third_party/mpdf60/ttfonts/DejaVuSansCondensed.ttf';
$TTCfontID='0';
$originalsize=664972;
$sip=false;
$smp=false;
...
$useOTL=255;
$rtlPUAstr='\x{0E1E5}-\x{0E1EF}\x{0E1F1}-\x{0E1FF}\x{0E21E}\x{0E222}\x{0E226}\x{0E23A}-\x{0E23F}\x{0E24A}-\x{0E24F}\x{0E25A}-\x{0E25F}\x{0E26A}-\x{0E26F}\x{0E277}\x{0E27A}-\x{0E280}\x{0E28A}-\x{0E28F}\x{0E292}\x{0E2A2}-\x{0E2F6}\x{0EF00}-\x{0EF19}';
