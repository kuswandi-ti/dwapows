...
<ul id="crumbs">
	...
	<li><b>Monitoring DO Retur - Open</b></li>
</ul>
...
<div id="tab-container">	
	<ul id="tab">
		<li><a href="<?= base_url('mdor/mdor_open'); ?>" class="active">Open</a></li>
		<li><a href="<?= base_url('mdor/mdor_close'); ?>">Close</a></li>
	</ul>
</div>
...
<div id="content-container">
	<ul id="accordion">
		...
		<ul>
			<li>
				<?= form_open('mdor/mdor_open/search'); ?>
					<table class="list-table">
						<tr>
							...
							<td>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="<?= base_url('mdor/mdor_open'); ?>" class="css-button">Refresh & View All</a>
							</td>
						</tr>
					</table>
				<?= form_close(); ?>
	...
	<div id="show">
        <table border="0" class="list-table custom-table">
			...
			<tr>
				...
				<td align='center'><?= $row['gr_reguler_no']; ?></td>
