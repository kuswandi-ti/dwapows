...
<div id="mainwrapper">
	...
	?>
			<a href="<?= base_url($row['menu_base_url']); ?>">
				<div id="box-2" class="box">
					<?php if ($row['menu_name']!=='receive' and 
					          $row['menu_name']!=='ir' and 
							  $row['menu_name']!=='stock' and 
							  $row['menu_name']!=='lcaf' and 
							  $row['menu_name']!=='uhpp') { ?>
						<section class='notification'>
							<?php
								...
								if ($row['menu_name']=='mdor') { $data_count=$mdor; }
							?>
	...
	<div style="color:red;padding:15px;font-size:medium;float:left" id="_blink"><b>* Waiting to Action</b></div>
